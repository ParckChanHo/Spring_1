...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		/*
		 * insert
		 * JdbcBean bean1 = new JdbcBean(); bean1.setInt_data(1);
		 * bean1.setStr_data("문자열1"); dao.insert_data(bean1);
		 * 
		 * JdbcBean bean2 = new JdbcBean(); bean2.setInt_data(2);
		 * bean2.setStr_data("문자열2"); dao.insert_data(bean2);
		 * 
		 ...
		 * bean4.setStr_data("문자열3"); dao.update_data(bean4);
		 */
